...
expName = 'VERSION4'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/hannah_checkeye/Desktop/UMW/Spring 2021/Verbal Shaping Experiment/Version 4/VERSION4_lastrun.py',
...
# Initialize components for Routine "adjectives_text"
adjectives_textClock = core.Clock()
...
end_2 = keyboard.Keyboard()
red_alien_2 = visual.ImageStim(
    win=win,
    name='red_alien_2', 
...
showtimer_2 = visual.TextStim(win=win, name='showtimer_2',
    text='default text',
    font='Arial',
    ...
    languageStyle='LTR',
    depth=-4.0);
actualhcount_2 = visual.TextStim(win=win, name='actualhcount_2',
    text='default text',
    font='Arial',
    pos=(0.6, -0.4), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-5.0);
displayhcount_3 = visual.TextStim(win=win, name='displayhcount_3',
    text='Hostage Count:',
    font='Arial',
    pos=(0.4, -0.4), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-6.0);
textborder_2 = visual.Rect(
    win=win, name='textborder_2',
    width=(0.9, 0.5)[0], height=(0.9, 0.5)[1],
    ori=0, pos=(0, 0),
    lineWidth=1, lineColor=[-1,-1,-1], lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
...
VATkeys_2 = visual.TextStim(win=win, name='VATkeys_2',
    text='Press the left key to choose the left word and the right key to choose the right word',
    font='Arial',
    pos=(0, -0.4), height=0.05, wrapWidth=None, ori=0, 
    color='red', colorSpace='rgb', opacity=1, 
...
# Initialize components for Routine "verb_text"
verb_textClock = core.Clock()
...
hcount = 0
countdownStarted = False
end_3 = keyboard.Keyboard()
green_alien_2 = visual.ImageStim(
    win=win,
    name='green_alien_2', 
    ...
    flipHoriz=False, flipVert=False,
    texRes=512, interpolate=True, depth=-3.0)
showtimer_3 = visual.TextStim(win=win, name='showtimer_3',
    text='default text',
    font='Arial',
    pos=(-0.5, -0.4), height=0.1, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-4.0);
actualhcount = visual.TextStim(win=win, name='actualhcount',
    text='default text',
    font='Arial',
    pos=(0.6, -0.4), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-5.0);
displayhcount_4 = visual.TextStim(win=win, name='displayhcount_4',
    text='Hostage Count:',
    font='Arial',
    pos=(0.4, -0.4), height=0.05, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-6.0);
textborder = visual.Rect(
    win=win, name='textborder',
    width=(0.9, 0.5)[0], height=(0.9, 0.5)[1],
    ori=0, pos=(0, 0),
    lineWidth=1, lineColor=[-1,-1,-1], lineColorSpace='rgb',
    fillColor=None, fillColorSpace='rgb',
...
VATkeys_3 = visual.TextStim(win=win, name='VATkeys_3',
    text='Press the left key to choose the left word and the right key to choose the right word',
    font='Arial',
    pos=(0, -0.4), height=0.05, wrapWidth=None, ori=0, 
    color='red', colorSpace='rgb', opacity=1, 
...
_key_resp_4_allKeys = []
# keep track of which components have finished
practice_VAT_instructionsComponents = [text_11, key_resp_4]
...
for thisTrial in trials:
    ...
    # ------Prepare to start Routine "adjectives_text"-------
    continueRoutine = True
    # update component parameters for each repeat
    modify = False
    text_9.text = ''
    ...
    end_2.rt = []
    _end_2_allKeys = []
    actualhcount_2.setText(hcount)
    # keep track of which components have finished
    adjectives_textComponents = [text_9, end_2, red_alien_2, showtimer_2, actualhcount_2, displayhcount_3, textborder_2]
    for thisComponent in adjectives_textComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    adjectives_textClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "adjectives_text"-------
    while continueRoutine:
        # get current time
        t = adjectives_textClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=adjectives_textClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if end_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            ...
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(end_2.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(end_2.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if end_2.status == STARTED and not waitOnFlip:
            theseKeys = end_2.getKeys(keyList=['return'], waitRelease=False)
            _end_2_allKeys.extend(theseKeys)
            if len(_end_2_allKeys):
                end_2.keys = [key.name for key in _end_2_allKeys]  # storing all keys
                end_2.rt = [key.rt for key in _end_2_allKeys]
                # a response ends the routine
                continueRoutine = False
        
        # *red_alien_2* updates
        if red_alien_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            red_alien_2.frameNStart = frameN  # exact frame index
            red_alien_2.tStart = t  # local t and not account for scr refresh
            red_alien_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(red_alien_2, 'tStartRefresh')  # time at next scr refresh
            red_alien_2.setAutoDraw(True)
        
        # *showtimer_2* updates
        if showtimer_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            showtimer_2.frameNStart = frameN  # exact frame index
            showtimer_2.tStart = t  # local t and not account for scr refresh
            showtimer_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(showtimer_2, 'tStartRefresh')  # time at next scr refresh
            showtimer_2.setAutoDraw(True)
        if showtimer_2.status == STARTED:  # only update if drawing
            showtimer_2.setText(timeText)
        
        # *actualhcount_2* updates
        if actualhcount_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            actualhcount_2.frameNStart = frameN  # exact frame index
            actualhcount_2.tStart = t  # local t and not account for scr refresh
            actualhcount_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(actualhcount_2, 'tStartRefresh')  # time at next scr refresh
            actualhcount_2.setAutoDraw(True)
        
        # *displayhcount_3* updates
        if displayhcount_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            displayhcount_3.frameNStart = frameN  # exact frame index
            displayhcount_3.tStart = t  # local t and not account for scr refresh
            displayhcount_3.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(displayhcount_3, 'tStartRefresh')  # time at next scr refresh
            displayhcount_3.setAutoDraw(True)
        
        # *textborder_2* updates
        if textborder_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            textborder_2.frameNStart = frameN  # exact frame index
            textborder_2.tStart = t  # local t and not account for scr refresh
            textborder_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(textborder_2, 'tStartRefresh')  # time at next scr refresh
            textborder_2.setAutoDraw(True)
    ...
    thisExp.addData('Frequency of adjectives', freq_sum)
    # check responses
    if end_2.keys in ['', [], None]:  # No response was made
        end_2.keys = None
    trials.addData('end_2.keys',end_2.keys)
    if end_2.keys != None:  # we had a response
        trials.addData('end_2.rt', end_2.rt)
    trials.addData('end_2.started', end_2.tStartRefresh)
    trials.addData('end_2.stopped', end_2.tStopRefresh)
    trials.addData('red_alien_2.started', red_alien_2.tStartRefresh)
    trials.addData('red_alien_2.stopped', red_alien_2.tStopRefresh)
    trials.addData('showtimer_2.started', showtimer_2.tStartRefresh)
    trials.addData('showtimer_2.stopped', showtimer_2.tStopRefresh)
    trials.addData('actualhcount_2.started', actualhcount_2.tStartRefresh)
    trials.addData('actualhcount_2.stopped', actualhcount_2.tStopRefresh)
    trials.addData('displayhcount_3.started', displayhcount_3.tStartRefresh)
    trials.addData('displayhcount_3.stopped', displayhcount_3.tStopRefresh)
    trials.addData('textborder_2.started', textborder_2.tStartRefresh)
    trials.addData('textborder_2.stopped', textborder_2.tStopRefresh)
    # the Routine "adjectives_text" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
...
VAT1trials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('VAT_Adjectives.xlsx'),
...
for thisVAT1trial in VAT1trials:
    ...
    _endchoice_allKeys = []
    # keep track of which components have finished
    VAT1Components = [sentence, choice1, choice2, image, endchoice, VATkeys_2]
    ...
    while continueRoutine:
        ...
        # *VATkeys_2* updates
        if VATkeys_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            VATkeys_2.frameNStart = frameN  # exact frame index
            VATkeys_2.tStart = t  # local t and not account for scr refresh
            VATkeys_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(VATkeys_2, 'tStartRefresh')  # time at next scr refresh
            VATkeys_2.setAutoDraw(True)
    ...
    VAT1trials.addData('VATkeys_2.started', VATkeys_2.tStartRefresh)
    VAT1trials.addData('VATkeys_2.stopped', VATkeys_2.tStopRefresh)
...
for thisTrial_2 in trials_2:
    ...
    # ------Prepare to start Routine "verb_text"-------
    continueRoutine = True
    # update component parameters for each repeat
    modify = False
    text_10.text = ''
    ...
    end_3.rt = []
    _end_3_allKeys = []
    actualhcount.setText(hcount)
    # keep track of which components have finished
    verb_textComponents = [text_10, end_3, green_alien_2, showtimer_3, actualhcount, displayhcount_4, textborder]
    for thisComponent in verb_textComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    verb_textClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "verb_text"-------
    while continueRoutine:
        # get current time
        t = verb_textClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=verb_textClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        # *end_3* updates
        waitOnFlip = False
        if end_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            end_3.frameNStart = frameN  # exact frame index
            end_3.tStart = t  # local t and not account for scr refresh
            end_3.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(end_3, 'tStartRefresh')  # time at next scr refresh
            end_3.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(end_3.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(end_3.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if end_3.status == STARTED and not waitOnFlip:
            theseKeys = end_3.getKeys(keyList=['return'], waitRelease=False)
            _end_3_allKeys.extend(theseKeys)
            if len(_end_3_allKeys):
                end_3.keys = [key.name for key in _end_3_allKeys]  # storing all keys
                end_3.rt = [key.rt for key in _end_3_allKeys]
                # a response ends the routine
                continueRoutine = False
        
        # *green_alien_2* updates
        if green_alien_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            green_alien_2.frameNStart = frameN  # exact frame index
            green_alien_2.tStart = t  # local t and not account for scr refresh
            green_alien_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(green_alien_2, 'tStartRefresh')  # time at next scr refresh
            green_alien_2.setAutoDraw(True)
        
        # *showtimer_3* updates
        if showtimer_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            showtimer_3.frameNStart = frameN  # exact frame index
            showtimer_3.tStart = t  # local t and not account for scr refresh
            showtimer_3.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(showtimer_3, 'tStartRefresh')  # time at next scr refresh
            showtimer_3.setAutoDraw(True)
        if showtimer_3.status == STARTED:  # only update if drawing
            showtimer_3.setText(timeText)
        
        # *actualhcount* updates
        if actualhcount.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            actualhcount.frameNStart = frameN  # exact frame index
            actualhcount.tStart = t  # local t and not account for scr refresh
            actualhcount.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(actualhcount, 'tStartRefresh')  # time at next scr refresh
            actualhcount.setAutoDraw(True)
        
        # *displayhcount_4* updates
        if displayhcount_4.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            displayhcount_4.frameNStart = frameN  # exact frame index
            displayhcount_4.tStart = t  # local t and not account for scr refresh
            displayhcount_4.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(displayhcount_4, 'tStartRefresh')  # time at next scr refresh
            displayhcount_4.setAutoDraw(True)
        
        # *textborder* updates
        if textborder.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            textborder.frameNStart = frameN  # exact frame index
            textborder.tStart = t  # local t and not account for scr refresh
            textborder.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(textborder, 'tStartRefresh')  # time at next scr refresh
            textborder.setAutoDraw(True)
    ...
    thisExp.addData('Hostage Count', hcount)
    thisExp.addData('Frequency of verbs', freq_sum)
    # check responses
    if end_3.keys in ['', [], None]:  # No response was made
        end_3.keys = None
    trials_2.addData('end_3.keys',end_3.keys)
    if end_3.keys != None:  # we had a response
        trials_2.addData('end_3.rt', end_3.rt)
    trials_2.addData('end_3.started', end_3.tStartRefresh)
    trials_2.addData('end_3.stopped', end_3.tStopRefresh)
    trials_2.addData('green_alien_2.started', green_alien_2.tStartRefresh)
    trials_2.addData('green_alien_2.stopped', green_alien_2.tStopRefresh)
    trials_2.addData('showtimer_3.started', showtimer_3.tStartRefresh)
    trials_2.addData('showtimer_3.stopped', showtimer_3.tStopRefresh)
    trials_2.addData('actualhcount.started', actualhcount.tStartRefresh)
    trials_2.addData('actualhcount.stopped', actualhcount.tStopRefresh)
    trials_2.addData('displayhcount_4.started', displayhcount_4.tStartRefresh)
    trials_2.addData('displayhcount_4.stopped', displayhcount_4.tStopRefresh)
    trials_2.addData('textborder.started', textborder.tStartRefresh)
    trials_2.addData('textborder.stopped', textborder.tStopRefresh)
    # the Routine "verb_text" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
...
IAT2trials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('VAT_Verbs.xlsx'),
...
for thisIAT2trial in IAT2trials:
    ...
    # keep track of which components have finished
    VAT_2Components = [sentence_2, choice1_2, choice2_2, image_2, endchoice_2, VATkeys_3]
    ...
    while continueRoutine:
        ...
        # *VATkeys_3* updates
        if VATkeys_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            VATkeys_3.frameNStart = frameN  # exact frame index
            VATkeys_3.tStart = t  # local t and not account for scr refresh
            VATkeys_3.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(VATkeys_3, 'tStartRefresh')  # time at next scr refresh
            VATkeys_3.setAutoDraw(True)
    ...
    IAT2trials.addData('VATkeys_3.started', VATkeys_3.tStartRefresh)
    IAT2trials.addData('VATkeys_3.stopped', VATkeys_3.tStopRefresh)
